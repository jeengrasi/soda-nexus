# SNX — PAQUETE DE CONTEXTO PARA IA

## Guía mínima para IA
- La memoria real del sistema está en Termux (~/soda), no en la IA.
- No inventes rutas ni estados: usa lo que ves aquí.
- No modifiques nada existente: solo propone archivos nuevos.
- Respeta la estructura, las fases y los scripts soberanos.
...
## Resultado del chequeo de invariantes
[SNX] Chequeando invariantes básicas...
[SNX] ANTIAMNESIA OK — todas las invariantes básicas se cumplen.
